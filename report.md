...
    using enplustion to to keep every feature a standalone
...
- so set out the complexity of your extension based on what you think can be achieved by the end of the module for the final submission.

- then plan it out. brain storm what it would look like

- outline the extension(s), break down the features and functionality,

- the tools and techniques required.

- the resources you will need, and

- how long each of the features would take you -

- chart it out on for a timeline.

- start the building process

- Keep in mind the coding techniques required
