/* It's a container for visualisations that can be selected and displayed */
class Gallery {
	constructor() {
		this.visuals = [];
	...
	selectVisual(visId) {
		...
		if (visIndex != null) {
			...
			if (this.selectedVisual != null && this.selectedVisual.hasMethod('destroy')) {
